...
import org.one2oneeum.net.eth.message.BlockHeadersMessage;
...
/**
 * Testing {@link org.one2oneeum.net.eth.handler.Eth62#isValid(BlockHeadersMessage, GetBlockHeadersMessageWrapper)}
 */
